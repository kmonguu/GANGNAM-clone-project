<style>
	.sub2_div1 { background: url('/m/images/subvisual/sub2_1/p2_1.jpg') no-repeat center top; height: 210px; }
	.sub2_div1 { background: url('/m/images/subvisual/sub2_1/p2_2.jpg') no-repeat center top; height: 2340px; }

		
	.swiper-mainvisual {margin:0 auto; width:640px; height:500px; position:relative; left:0; top:0; right:0; z-index:1; overflow:hidden; }
...
<div class="swiper-mainvisual swiper-mainvisual-container4" >


	 <div class="swiper-wrapper">
		<?for($i=1; $i<=6; $i++){?>
			<div style="background:url('/m/images/subvisual/sub2_1/<?=$i?>.jpg');width:100%;background-position:center center;" class="swiper-slide" >
...
<div class="sub2_div1"></div>

<div class="sub2_div2"></div>
...
<script>
	...
	$(function(){
		...
		swiper_mainvisual = new Swiper('.swiper-mainvisual-container4', {
						spaceBetween: 0,
						centeredSlides: true,
						autoplay: {
							delay: 4000,
